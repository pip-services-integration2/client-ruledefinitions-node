# Development and Testing Guide <br/> RuleDefinitions service Microservice Client SDK for Node.js
...
```bash
git clone git@github.com/pip-services-integration2/client-ruledefinitions-node.git
```
