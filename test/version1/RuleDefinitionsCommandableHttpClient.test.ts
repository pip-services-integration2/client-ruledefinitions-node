...
import { RuleDefinitionsCommandableHttpClientV1 } from '../../src/version1/RuleDefinitionsCommandableHttpClientV1';
import { RuleDefinitionsClientV1Fixture } from './RuleDefinitionsClientV1Fixture';

suite('RuleDefinitionsCommandableHttpClientV1', () => {
    ...
    let client: RuleDefinitionsCommandableHttpClientV1;
    ...
    setup(async () => {
        ...
        client = new RuleDefinitionsCommandableHttpClientV1();
        ...
        let references = References.fromTuples(
            ...
            new Descriptor('service-ruledefinitions', 'client', 'commandable-http', 'default', '1.0'), client
        );
